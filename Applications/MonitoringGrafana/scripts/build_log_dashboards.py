...
def explorer():
    ...
    spec = {
        "uid": "mon-log-explorer", "title": "Log Explorer", "from": "now-1h", "refresh": "1m", "category_title": "Monitoring Logs", "category_tag": "monitoring-logs", "vars": vars,
...
def pipeline():
    ...
    spec = {
        "uid": "mon-log-pipeline", "title": "Log Pipeline Health", "from": "now-1h", "refresh": "1m", "category_title": "Monitoring Logs", "category_tag": "monitoring-logs", "vars": [],
...
def finalize(dashboard):
    dashboard["tags"] = ["monitoring", "monitoring-logs", "logs"]
    return dashboard
